...
class ScrapingMainSSI(ReadsFiles):
    ...
    def scrape_info(self):
        ...
        for one_cui in range(len(lista_cui)):
            ...
            r.click('//*[@id="divContainer"]/div[1]/div[1]/div/table/tbody/tr[3]/td[1]/ul/li[1]/div/span')
            time.sleep(3)

            if not r.present('//*[@id="divVistaPreliminar"]/table[1]/tbody/tr[1]/td[1]'):
                time.sleep(2)

            print(f"Se esta trabajando el registro {one_cui} con el CUI {lista_cui[one_cui]}")
